"""
Django settings for holy_glade_41740 project.
...
ROOT_URLCONF = 'holy_glade_41740.urls'
...
WSGI_APPLICATION = 'holy_glade_41740.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "holy_glade_41740 API",
    "DESCRIPTION": "API documentation for holy_glade_41740 App",
    "VERSION": "v1",
}
